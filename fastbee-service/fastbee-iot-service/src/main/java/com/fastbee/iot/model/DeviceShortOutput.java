...
public class DeviceShortOutput
{
    ...
    public DeviceAlertCount getAlertCount() {
        return alertCount;
    }

    public void setAlertCount(DeviceAlertCount alertCount) {
    ...
    public List<ThingsModelValueItem> getThingsModels() {
        return thingsModels;
    }

    public void setThingsModels(List<ThingsModelValueItem> thingsModels) {
