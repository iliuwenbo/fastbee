...
public class SceneScriptServiceImpl implements ISceneScriptService
{
    ...
    public int deleteSceneScriptBySceneIds(Long[] sceneIds) {
        return sceneScriptMapper.deleteSceneScriptBySceneIds(sceneIds);
    }

    @Override
    public int insertSceneScriptList(List<SceneScript> sceneScriptList) {
        return sceneScriptMapper.insertSceneScriptList(sceneScriptList);
    }

    @Override
    public List<SceneScript> listSceneScriptByPurpose(List<Long> sceneIdList, Integer scriptPurpose) {
        return sceneScriptMapper.listSceneScriptByPurpose(sceneIdList, scriptPurpose);
    }
