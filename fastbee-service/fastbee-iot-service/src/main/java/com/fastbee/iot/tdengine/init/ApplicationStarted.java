package com.fastbee.iot.tdengine.init;
...
public class ApplicationStarted  {
    ...
    public void run() {
        ...
        if (containBean(TDengineConfig.class)) {
            this.tdengineConfig = applicationContext.getBean(TDengineConfig.class);
            this.deviceLogMapper= applicationContext.getBean(TDDeviceLogDAO.class);
            this.dataSource = (DruidDataSource) tdengineConfig.createDataSource();
            initTDengine(this.tdengineConfig.getDbName());
    ...
    */
    private void createDatabase(){
        try {
            String dbName = tdengineConfig.getDbName();
