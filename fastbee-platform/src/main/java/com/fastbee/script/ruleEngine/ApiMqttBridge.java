...
@Slf4j
@LiteflowComponent("apiMqttBridge")
public class ApiMqttBridge extends NodeComponent {
    @Autowired
    ...
    public void process() throws Exception {
        // 获取上下文对象
        ApiMsgContext cxt = this.getContextBean(ApiMsgContext.class);
        ...
        if (bridge != null) {
            ...
            MqttAsyncClient client = ApiMqttClientFactory.instance(mqttClientService.buildmqttclientconfig(config));
