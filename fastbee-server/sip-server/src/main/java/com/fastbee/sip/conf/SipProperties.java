...
public class SipProperties {
    public static Properties getProperties(String name, boolean openLog) {
        ...
        if (openLog) {
            // properties.setProperty("gov.nist.javax.sip.STACK_LOGGER", "com.fastbee.sip.conf.StackLoggerImpl");
            properties.setProperty("gov.nist.javax.sip.SERVER_LOGGER", "com.fastbee.sip.conf.ServerLoggerImpl");
